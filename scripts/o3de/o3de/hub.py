...
_LINUX_PACKAGE_NAMES = {
    ...
    'Build libraries (Linux)': {
        'apt-get': ['pkg-config', 'clang-tools', 'binutils', 'libglu1-mesa-dev', 'libxcb-xinerama0',
        ...
        'dnf': ['pkgconf-pkg-config', 'clang-tools-extra', 'binutils', 'mesa-libGLU-devel', 'fontconfig-devel',
        ...
        'pacman': ['pkgconf', 'clang', 'binutils', 'glu', 'fontconfig', 'libxkbcommon-x11',
